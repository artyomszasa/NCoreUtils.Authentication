    ...
    class OAuth2DbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Permission>(b =>
            {
                ...
                b.HasIndex(e => new { e.Name, e.ClientApplictionId });
                b.HasOne(e => e.ClientApplication).WithMany(e => e.Permissions).HasForeignKey(e => e.ClientApplictionId).OnDelete(DeleteBehavior.Restrict);
            });
