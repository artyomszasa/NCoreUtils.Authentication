...
namespace NCoreUtils.OAuth2.WebService.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Permission_ClientApplication_ClientApplictionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Permission_ClientApplictionId",
                table: "Permission",
                column: "ClientApplictionId");

            migrationBuilder.CreateIndex(
                name: "IX_Permission_Name_ClientApplictionId",
                table: "Permission",
                columns: new[] { "Name", "ClientApplictionId" });
